...
import me.akamex.luckapi.util.itemstack.reader.ItemReaders;
import me.akamex.luckapi.util.itemstack.reader.ReadItem;
...
public final class MenuReaders {
    ...
    private enum IndexYamlMenuReader implements YamlMenuReader {
        ...
        public ReadMenu read(ConfigurationSection section) {
            if(section == null) {
                return new ReadMenu("", 54, InventoryType.CHEST, new HashMap<>());
            }
            ...
            return new ReadMenu(title, size, inventoryType, buttonMap);
        }
    }
