...
import me.akamex.luckapi.event.ExtendedListener;
...
public class LuckMenuService extends ExtendedListener implements MenuService {

    public LuckMenuService(Plugin plugin) {
        super(plugin);
    }
